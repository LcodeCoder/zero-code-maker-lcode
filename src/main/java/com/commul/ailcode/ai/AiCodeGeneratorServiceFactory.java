...
import com.commul.ailcode.ai.tools.FileWriteTool;
...
public class AiCodeGeneratorServiceFactory {
    ...
    /**
     * 根据 appId 获取服务（带缓存） 开闭原则 为了兼容老的逻辑
     */
    ...
    public AiCodeGeneratorService getAiCodeGeneratorService(long appId, CodeGenTypeEnum codeGenType) {
        ...
        return serviceCache.get(cacheKey, _ -> createAiCodeGeneratorService(appId, codeGenType));
    }
...
//                // 根据 id 构建独立的对话记忆，这个是系统自带的，现在换一个思路写
